    ...
    <div class="contact-us-container">
        <div class="contact-us-section contact-us-section1">
            ...
            <form action="" method="POST">
                ...
                <textarea placeholder="Enter your message !" name="feedback" rows="10" cols="30"
        ...
        <div class="contact-us-section contact-us-section2">
            <h1>Address & Info</h1>
            <h3>Phone Numbers</h3>
            <p><a href="tel:01011391148">+216 000 00000</a><br>
                <a href="tel:01011391148">+216 000 00000</a>
            </p>
            <h3>Address</h3>
            <p>SAHLOUL , ceinture , Sahloul 11837 - P.O. Box 43</p>
            <h3>E-mail</h3>
            <p><a href="mailto:cinemareservation@bue.edu.eg">epicinemareservation@epi.edu.eg</a></p>
        </div>
    </div>
    <div style="width: 75%; height: 350px; margin: 15%;">
        <div class="gmap_canvas"><iframe id="gmap_canvas"
                src="https://maps.google.com/maps?q=BUE&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0"
