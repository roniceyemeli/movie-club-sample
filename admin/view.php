                            ...
                            while ($row = mysqli_fetch_array($run)) {
                                ...
                                <tr align="center">
                                    ...
                                    <td><button type="submit" type="button"
                                            class="btn btn-outline-danger"><?php echo "<a href='deleteBooking.php?id=" . $row['bookingID'] . "' style='text-decoration:none'>delete</a>"; ?></button><button
                                            name="update" type="submit" onclick="" type="button"
                                            class="btn btn-outline-warning"><?php echo "<a href='editBooking.php?id=" . $row['bookingID'] . "' style='text-decoration:none'>update</a>"; ?></button>
                                    </td>
                                    <td></td>
                                </tr>
